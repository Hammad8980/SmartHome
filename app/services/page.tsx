    ...
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">Our Security Services</h1>
          <p className="text-xl md:text-2xl max-w-3xl mx-auto">
            Complete smart home security automation solutions with professional installation and maintenance
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-4xl font-bold text-gray-900 mb-6">Electric Fencing Systems</h2>
                <p className="text-lg text-gray-600 mb-6">
                  Our electric fencing solutions provide the ultimate perimeter security for your property. Using high-voltage, low-amperage technology, our systems deliver a safe but effective deterrent against intruders.
                </p>
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-700">High-voltage perimeter protection</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-6 h-6 flex items-center justify-center">
                      <i className="ri-check-line text-green-600"></i>
                    </div>
                    <span className="text-gray-700">Smart monitoring and alert system</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-6 h-6 flex items-center justify-center">
                      <i className="ri-check-line text-green-600"></i>
          ...
          <div className="mb-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <h2 className="text-4xl font-bold text-gray-900 mb-6">CCTV Security Cameras</h2>
                <p className="text-lg text-gray-600 mb-6">
                  State-of-the-art surveillance systems with high-definition recording, night vision, and remote monitoring capabilities. Our CCTV solutions provide comprehensive coverage of your property.
                </p>
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    <div className="w-6 h-6 flex items-center justify-center">
                    ...
                    <span className="text-gray-700">4K Ultra HD recording quality</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-6 h-6 flex items-center justify-center">
                      <i className="ri-check-line text-green-600"></i>
                    </div>
                    <span className="text-gray-700">Night vision and motion detection</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-6 h-6 flex items-center justify-center">
                      <i className="ri-check-line text-green-600"></i>
                    </div>
                    <span className="text-gray-700">Mobile app remote access</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-6 h-6 flex items-center justify-center">
                      <i className="ri-check-line text-green-600"></i>
                    </div>
                    <span className="text-gray-700">Cloud storage and local backup</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mb-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-4xl font-bold text-gray-900 mb-6">Solar System Installation</h2>
                <p className="text-lg text-gray-600 mb-6">
                  Sustainable solar power solutions to keep your security systems running efficiently. Our solar installations provide reliable backup power and reduce operational costs.
                </p>
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    <div className="w-6 h-6 flex items-center justify-center">
                    ...
                    <span className="text-gray-700">High-efficiency solar panels</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-6 h-6 flex items-center justify-center">
                      <i className="ri-check-line text-green-600"></i>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-700">25-year warranty on panels</span>
                  </div>
                </div>
              </div>
              <div>
          ...
          <div className="bg-white rounded-3xl p-12 shadow-lg">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl font-bold text-gray-900 mb-6">Long-term Management & Inspection</h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Our comprehensive maintenance program ensures your security systems operate at peak performance year-round with regular inspections and proactive servicing.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">Quarterly system checks and performance evaluations</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">Proactive repairs and component replacements</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">Emergency response and technical support</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Contact us today for a free consultation and customized security solution for your property
          </p>
