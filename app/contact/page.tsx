      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto">
            Get in touch for a free consultation and customized security
            solution
          </p>
        </div>
      </section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="biometric-access">
                          Biometric Access Control
                        </option>
                        <option value="gsm-communication">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <p className="text-gray-600">
                Installation time varies by system complexity. Electric fencing
                typically takes 1-2 days, CCTV systems 1 day, solar
                installations 2-3 days, biometric systems 1-2 days, and GSM
                communication modules can be installed within hours. We provide
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <p className="text-gray-600">
                Yes! We provide comprehensive warranties: 5 years on
                installations, 2 years on equipment, and 25 years on solar
                panels. All warranties include free maintenance and support.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <p className="text-gray-600">
                Absolutely! All our systems include mobile app access for remote
                monitoring, alerts, and control. You can view cameras, check
                system status, and receive notifications anywhere.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <p className="text-gray-600">
                We handle all maintenance through our service plans. This
                includes quarterly inspections, software updates, equipment
                cleaning, and proactive repairs to ensure optimal performance.
              </p>
            </div>
          </div>
        </div>
